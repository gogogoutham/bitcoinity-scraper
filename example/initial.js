...
async.series([
    ...
    taskGenerator('volume', '30d', 'hour'),
    taskGenerator('price', '30d', 'hour'),
    taskGenerator('tradespm', '30d', 'hour'),
    taskGenerator('volume', '2y', 'day'),
    taskGenerator('price', '2y', 'day'),
    taskGenerator('tradespm', '2y', 'day')
], function(err, result) {
    if ( !err ) {
