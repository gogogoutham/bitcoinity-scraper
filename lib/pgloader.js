...
exports.run = function(dbConfigFile, tableName, insertFields, keyFields, data, sqlMode) {

    //Parse credentials from configuration file
    ...
    var url = "postgres://" + username + ":" + password + "@" + hostname + ":" + port + "/" + database;
